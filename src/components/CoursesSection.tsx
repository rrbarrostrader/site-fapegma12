...
const categories = [
  {
    ...
    courses: ["Administração", "Pedagogia", "Teologia", "História", "Matemática", "Língua Portuguesa/Inglês/Espanhol"],
    color: "bg-primary",
  ...
  },
  {
    ...
    courses: ["Educação Física", "Psicopedagogia", "ABA", "AEE", "Educação Infantil", "Clínica", "Gestão Escolar", "Nutrição Esportiva"],
    color: "bg-accent",
  ...
  },
  {
    ...
    courses: ["Enfermagem (Técnico)", "Técnico em Estética"],
    color: "bg-navy-dark",
    textColor: "text-white",
  },
];
